...
for participant in ['AC', 'CL', 'FW', 'HB', 'KK', 'LM', 'MC', 'MP1', 'MP2', 'NN', 'RP','SD', 'TJ', 'TS', 'WT']:
    ...
    for a,b in permutations(feature_sets,2):
        ...
        temp.to_csv(os.path.join(saving_dir,f'Pos_3_1_features_{participant}_{a}_{b}.csv'),index=False) # save as a csv
...
for participant in ['AC', 'CL', 'FW', 'HB', 'KK', 'LM', 'MC', 'MP1', 'MP2', 'NN', 'RP','SD', 'TJ', 'TS', 'WT']:
    ...
    for a,b in permutations(feature_sets,2):
        ...
        temp.to_csv(os.path.join(saving_dir,f'Pos_3_1_features_{participant}_{a}_{b} (chance).csv'),index=False) # save as a csv
