...
temp.to_csv(os.path.join(saving_dir,'Pos_6_features (experiment score)_{}.csv'.format(participant)),index=False) # save as a csv
################################################################################
...
temp = pd.DataFrame(results)
temp.to_csv(os.path.join(saving_dir,'Pos_RT_features (experiment score)_{}.csv'.format(participant)),index=False) # save as a csv
