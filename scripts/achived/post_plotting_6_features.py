...
if __name__ == '__main__':
    ...
    g.fig.savefig(os.path.join(saving_dir,
                               'Model Comparison of Decoding Probability of Success_6_features.png'),
              dpi                 = 500,
              bbox_inches         = 'tight')
...
#                                     palette  = "RdBu",
    ...
    g.savefig(os.path.join(saving_dir,'Weights plot of Probability of Success_6_features.png'),
               dpi                = 500,
               bbox_inches        = 'tight',)
    ...
    g.fig.suptitle('Model Comparison of Decoding Attention\nall 6 Features',
     y=1.02,x=0.45)
    g.savefig(os.path.join(saving_dir,'Model Comparison of Decoding Attention_6_features.png'),
              dpi                 = 500,
              bbox_inches         = 'tight')
...
#                           palette  = "RdBu",
    ...
    g.fig.axes[0].set(ylabel='Feature Importance')
    g.fig.axes[1].set(ylabel='Coefficients')
    g.savefig(os.path.join(saving_dir,'Weights plot of Attention_6_features.png'),
              dpi                  = 500,
              bbox_inches          = 'tight',)
    ...
    g.savefig(os.path.join(saving_dir,'Significance test of Proabability of Success_6_features.png'),
              dpi               = 500,
              bbox_inches       = 'tight')
    ...
    g.savefig(os.path.join(saving_dir,'Significance test of Attention_6_features.png'),
              dpi                = 500,
              bbox_inches        = 'tight')
