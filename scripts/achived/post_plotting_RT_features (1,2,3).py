...
if __name__ == '__main__':
    ...
    g.fig.savefig(os.path.join(saving_dir,
                               'Model Comparison of Decoding Probability of Success_RT_features(1,2,3).png'),
              dpi                 = 500,
              bbox_inches         = 'tight')
    ...
    g.savefig(os.path.join(saving_dir,'Weights plot of Probability of Success_RT_features(1,2,3).png'),
               dpi                = 500,
               bbox_inches        = 'tight',)
    ...
    g.fig.suptitle('Model Comparison of Decoding Attention\nRT of Awareness, Correctness, and Condifence as Features',
     y=1.02,x=0.45)
    g.savefig(os.path.join(saving_dir,'Model Comparison of Decoding Attention_RT_features(1,2,3).png'),
              dpi                 = 500,
              bbox_inches         = 'tight')
    ...
    g.fig.axes[0].set(ylabel='Feature Importance')
    g.fig.axes[1].set(ylabel='Coefficients')
    g.savefig(os.path.join(saving_dir,'Weights plot of Attention_RT_features(1,2,3).png'),
              dpi                  = 500,
              bbox_inches          = 'tight',)
