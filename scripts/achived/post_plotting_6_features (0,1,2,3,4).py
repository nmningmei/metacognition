...
#                         palette    = "RdBu",
    ...
    g.fig.savefig(os.path.join(saving_dir,
                               'Model Comparison of Decoding Probability of Success_6_features (1,2,3,4).png'),
              dpi                 = 500,
              bbox_inches         = 'tight')
...
#    df_post.fillna(1)
    ...
    g.savefig(os.path.join(saving_dir,'Weights plot of Probability of Success_6_features(1,2,3,4).png'),
               dpi                = 500,
               bbox_inches        = 'tight',)
...
#                         palette    = "RdBu",
    ...
    g.fig.suptitle('Model Comparison of Decoding \nAttention\nAll 6 Features',
     y=1.15,x=0.5)
    g.savefig(os.path.join(saving_dir,'Model Comparison of Decoding Attention_6_features(1,2,3,4).png'),
              dpi                 = 500,
              bbox_inches         = 'tight')
...
#    df_post.fillna(1)
    ...
    g.fig.axes[1].axhline(1.,color='red',linestyle='--',alpha=0.6)
    [ax.yaxis.set_major_formatter(FormatStrFormatter('%.2f')) for ax in g.fig.axes]
    g.savefig(os.path.join(saving_dir,'Weights plot of Attention_6_features(1,2,3,4).png'),
              dpi                  = 500,
              bbox_inches          = 'tight',)
    ...
    pos_ttest = pd.read_csv('../results/Pos_ttest_6_features.csv')
    att_ttest = pd.read_csv('../results/ATT_ttest_6_features.csv')
    ...
    g.savefig(os.path.join(saving_dir,'Significance test of Proabability of Success_6_features (1,2,3,4).png'),
              dpi               = 500,
              bbox_inches       = 'tight')
    ...
    g.savefig(os.path.join(saving_dir,'Significance test of Attention_6_features (1,2,3,4).png'),
              dpi                = 500,
              bbox_inches        = 'tight')
